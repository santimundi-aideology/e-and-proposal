...
function StackExampleFlow() {
  const STEPS = [
    ...
    {l:"3",where:"Model Layer",who:"LLM — fixed or brokered",what:"Depending on the agent's use case, the LLM is either fixed at build time (one model configured into the agent for the workload) or brokered at runtime (Forge selects between Claude, GPT, Llama, or a sovereign model based on task type, latency, and data-residency rules)."},
